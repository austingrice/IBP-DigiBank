...
declare const DigibankCommercialpaperApplication_base: (new (...args: any[]) => {
    [x: string]: any;
    projectRoot: string;
...
export declare class DigibankCommercialpaperApplication extends DigibankCommercialpaperApplication_base {
